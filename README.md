...
An interactive command-line tool for exploring Oracle database schemas. Built with Python and featuring a modern Text User Interface (TUI) powered by [Textual](https://textual.textualize.io/).

![Oracle-CLI TUI](https://via.placeholder.com/800x400?text=Oracle-CLI+TUI+Screenshot)
